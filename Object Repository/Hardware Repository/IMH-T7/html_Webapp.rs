...
<WebElementEntity>
   ...
   <name>html_Webapp</name>
   <tag></tag>
   <elementGuidId>91fc2a63-d697-42b1-8f1d-b55d5aa9d943</elementGuidId>
   <selectorCollection>
      <entry>
         <key>XPATH</key>
         <value>//html</value>
...
.close-sidenav {
  background: white url(&quot;data:image/svg+xml,%3Csvg xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22 viewBox%3D%220 0 45 45%22%3E  %3Cdefs%3E    %3Cstyle%3E      .cls-1 %7B        fill%3A %23ccc%3B        stroke%3A %23ccc%3B        opacity%3A 0.453%3B      %7D      .cls-2 %7B        opacity%3A 0.425%3B      %7D      .cls-3 %7B        stroke%3A none%3B      %7D      .cls-4 %7B        fill%3A none%3B      %7D    %3C%2Fstyle%3E  %3C%2Fdefs%3E  %3Cg id%3D%22close%22 transform%3D%22translate(-1836 -24)%22%3E    %3Cg id%3D%22Rectangle_13%22 data-name%3D%22Rectangle 13%22 class%3D%22cls-1%22 transform%3D%22translate(1836 24)%22%3E      %3Crect class%3D%22cls-3%22 width%3D%2245%22 height%3D%2245%22 rx%3D%225%22%2F%3E      %3Crect class%3D%22cls-4%22 x%3D%220.5%22 y%3D%220.5%22 width%3D%2244%22 height%3D%2244%22 rx%3D%224.5%22%2F%3E    %3C%2Fg%3E    %3Cpath id%3D%22np_close_317953_000000%22 class%3D%22cls-2%22 d%3D%22M16.289%2C30.539a1.2%2C1.2%2C0%2C0%2C0%2C.834.352%2C1.147%2C1.147%2C0%2C0%2C0%2C.834-.352l5.488-5.488%2C5.488%2C5.488a1.2%2C1.2%2C0%2C0%2C0%2C.834.352%2C1.175%2C1.175%2C0%2C0%2C0%2C.834-2L25.114%2C23.4%2C30.6%2C17.916a1.164%2C1.164%2C0%2C0%2C0-1.646-1.646l-5.488%2C5.488L17.98%2C16.27a1.164%2C1.164%2C0%2C0%2C0-1.646%2C1.646L21.822%2C23.4l-5.488%2C5.488a1.116%2C1.116%2C0%2C0%2C0-.045%2C1.646Z%22 transform%3D%22translate(1835.052 23.076)%22%2F%3E  %3C%2Fg%3E%3C%2Fsvg%3E&quot;) no-repeat right;
  width: 42px;
  height: 40px;
  border: none;
  margin-right: 13px;
...
.tooltip-inner {
  background-color: #2496b2 !important;
  color: #ffffff;
  text-align: left;
  padding: 8px;
}
...
.bs-tooltip-top .arrow::before {
  ...
  border-top-color: #2496b2;
}
.logo[_ngcontent-c0] {
  margin-left: -115px;
}
  .logged-in-user[_ngcontent-c0] {
  margin-top: 10px !important;
  margin-right: 10px !important;
  height: 30px !important;
  line-height: 1 !important;
}
  .search-bar[_ngcontent-c0] {
  background: #E8E9EA url('search_icon.png') no-repeat;
  
  
  padding: 16px 0px 12px 51px;
...
.sub_login_div[_ngcontent-c3] {
  margin-top: 280px;
  margin-left: 24px;
}

.input_type[_ngcontent-c3] {
  width: 350px;
  padding-bottom: 8px;
  border: none;
...
.login_btn[_ngcontent-c3] {
  width: 120px;
  color: green;
  font-weight: bold;
  opacity: 0.9;
  border-radius: 50px;
  background-image: linear-gradient(to bottom right, #84C128, #F7E28F);
}

[_ngcontent-c3]::-webkit-input-placeholder {
  opacity: 0.4;
}

[_ngcontent-c3]::-moz-placeholder {
  opacity: 0.4;
}

[_ngcontent-c3]::-ms-input-placeholder {
  opacity: 0.4;
}

[_ngcontent-c3]::placeholder {
  opacity: 0.4;
}

.heading[_ngcontent-c3] {
  margin-left: -81px;
  margin-top: 25px;
  font-size: 40px;
  font-weight: bolder;
  color: black;
  line-height: 55px;
}#katalon{font-family:monospace;font-size:13px;background-color:rgba(0,0,0,.7);position:fixed;top:0;left:0;right:0;display:block;z-index:999999999;line-height: normal} #katalon div{padding:0;margin:0;color:#fff;} #katalon kbd{display:inline-block;padding:3px 5px;font:13px Consolas,&quot;Liberation Mono&quot;,Menlo,Courier,monospace;line-height:10px;color:#555;vertical-align:middle;background-color:#fcfcfc;border:1px solid #ccc;border-bottom-color:#bbb;border-radius:3px;box-shadow:inset 0 -1px 0 #bbb;font-weight: bold} div#katalon-spy_elementInfoDiv {color: lightblue; padding: 0px 5px 5px} div#katalon-spy_instructionDiv {padding: 5px 5px 2.5px}.custom-dispatch-sidenav[_ngcontent-c4] {
  padding-left: 62%;
  width: 100%;
  background: rgba(44, 41, 41, 0.5);
  font-family: 'Montserrat', sans-serif;
...
.action-btn[_ngcontent-c4] {
  border: none;
  cursor: pointer;
}

.edit-delete-icons[_ngcontent-c4] {
  color: #646464;
  opacity: 0.5;
}

.dispatch-icon[_ngcontent-c4] {
  color: #ea8c1f;
}

.order-type[_ngcontent-c4] {
  font-weight: 600;
  color: #232323;
}

.order-spec-list[_ngcontent-c4] {
  font-size: 13px;
  font-weight: 400;
  margin-top: 15px;
  display: inline-block;
...
.card-contents[_ngcontent-c4] {
  padding: 0;
}

.card-box-heading[_ngcontent-c4] {
  font-weight: 500;
  color: #646464;
  width: 70%;
  text-overflow: ellipsis;
...
.track_order[_ngcontent-c4] {
  color: #10c377;
  font-size: 14px;
  border-bottom: 1px solid #10c377;
}

.see-all[_ngcontent-c4] {
  border: none;
  color: #959595;
  cursor: pointer;
  margin-left: -25px;
...
.orders-table[_ngcontent-c4] {
  margin-top: 30px;
}

.arrow-icon[_ngcontent-c4] {
  color: #ea8c1f;
  font-size: 25px;
}

.arrow-btn[_ngcontent-c4] {
  background: none;
  border: none;
}

button[_ngcontent-c4]:disabled {
  opacity: 0.3;
}

.bottom_info[_ngcontent-c4] {
  font-size: 13px;
  margin-top: 10px;
  color: #bb1e40;
  margin-left: 1px;
...
.tooltip-header[_ngcontent-c4] {
  font-weight: 600;
  margin-bottom: 5px;
  text-decoration: underline;
}

.tooltip-row[_ngcontent-c4] {
  margin-left: 0px;
  margin-bottom: -2px;
}

.tooltip-row[_ngcontent-c4]   .title[_ngcontent-c4] {
  font-weight: 600;
  margin-right: 8px;
}.order-details[_ngcontent-c9] {
  margin: -35px;
  padding: 15px;
  padding-left: 37px;
  background: #e8e9ea;
...
.hardware-category-btn[_ngcontent-c9] {
  color: #959595;
  border: none;
  cursor: pointer;
  font-weight: 600;
...
.active[_ngcontent-c9] {
  width: 134px;
  color: #84c128;
}

.choose-order[_ngcontent-c9] {
  height: 400px;
  margin-left: -50px;
  margin-top: 35px;
}

.search-bar[_ngcontent-c9]    > .search_box[_ngcontent-c9] {
  border: none;
  font-weight: 500;
}

.placed-order-title[_ngcontent-c9] {
  color: #666666;
  font-weight: 600;
}

.order-summary[_ngcontent-c9] {
  color: #959595;
  font-size: 15px;
  font-weight: 500;
  margin-top: 10px;
...
.hardware-category-tbl[_ngcontent-c9] {
  background: #84c128;
  border: none;
  width: 142px;
}

.chosen-bulk-item[_ngcontent-c9] {
  margin-left: 23px;
  margin-top: 8px;
  width: 100%;
...
.chosen-bulk-item[_ngcontent-c9]   .header[_ngcontent-c9] {
  font-weight: 600;
}

.with-details-needed[_ngcontent-c9] {
  font-weight: 600px;
}

.details[_ngcontent-c9] {
  margin-top: 7px;
}

.details-row[_ngcontent-c9] {
  margin-bottom: 5px;
}.btn-group-xs[_ngcontent-c11]    > .btn[_ngcontent-c11], .btn-xs[_ngcontent-c11] {
    padding  : .25rem .4rem;
    font-size  : .875rem;
    line-height  : .5;
    border-radius : .2rem;
...
.upload-btn-wrapper[_ngcontent-c11] {
  position: relative;
  overflow: hidden;
  display: inline-block;
}

.upload-btn-wrapper[_ngcontent-c11]   input[type=file][_ngcontent-c11] {
  font-size: 100px;
  position: absolute;
  left: 0;
  top: 0;
...
.choose-file-btn[_ngcontent-c11] {
  width: 139px;
  border-radius: 0;
  border: 0;
  color: #646464;
...
.close-btn[_ngcontent-c11] {
  ...
  position: relative;
  top: -10px;
}.order-add-background[_ngcontent-c6] {
    color:#959595
}

.add-more-close-btn[_ngcontent-c6] {
    width: 1px;
    margin-top: 28px;
}

.order-for[_ngcontent-c6] {
    margin-bottom: 20px;
}

.item-row[_ngcontent-c6] {
    margin: 10px;
}

.close-btn[_ngcontent-c6] {
    border: none;
    position: relative;
    top: 9px;
  }

.no-margin-bottom[_ngcontent-c6] {
  margin-bottom: 0px;
}

.selected-templates[_ngcontent-c6] {
    display: inline-flex;
...
.search-bar[_ngcontent-c15]    > .search_box[_ngcontent-c15] {
  border: none;
  font-weight: 500;
}

  adminORDERSHARDWARESUSERSSTAKEHOLDERSBULK ITMESHARDWARE TYPESMACHINE TEMPLATESPRICE MODELSREPORTSHardwareBulk ItemsAdd Hardware×Hardware Type *GPSAntinaMCUMorataMCU BoxRFID ReaderHw2Hw3Hw4Hw5Hw6Hw7Hw8Hw9Hw10Name * Serial Number *Repaired Item    Yes   No Price Model *rfid readerInstalled At *Created Date Keep on addingUpdate Location×Enter new installed at:Hardwares+ AddShow dispatchedSNo.NameSerial NumberTypeModelRepairedCreated AtLocationActions1MCUBOX_1MCUBOX_1MCU Box23/07/2019 01:30CNB : Assembly RoomEdit | Expire2MORATA_123MORATA_123Moratam | m23/07/2019 01:29CNB : Assembly RoomEdit | Expire3MCU_1MCU_1MCUm | m23/07/2019 01:28CNB : Assembly RoomEdit | Expire
